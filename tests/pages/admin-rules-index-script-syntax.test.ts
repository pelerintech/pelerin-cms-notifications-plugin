...
const PAGE_PATH = join(__dirname, '../../src/pages/admin/rules/index.astro');
...
/**
 * Regression guard: the client `<script>` in the rules/index.astro page must be
 ...
 */
describe('admin rules/index.astro page — client <script> syntax', () => {
